...
export default function SharePage() {
  ...
  const universal = assignmentId ? `${base}/?a=${assignmentId}` : '';
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-xl border bg-white p-4 space-y-3">
        ...
        <div className="mt-1 flex gap-2">
          ...
          <button className="btn-primary" disabled={!assignmentId} onClick={() => navigator.clipboard.writeText(universal)}>Copy</button>
        </div>
      </div>
      ...
      <div className="rounded-xl border bg-white p-4">
        ...
        <div className="mt-2 flex items-center justify-between">
          ...
          <a href={`/assignment/${assignmentId}/report`} className="btn-secondary">Open Report</a>
        </div>
      </div>
    </div>
  );
